/*
  To use this example, you need a few libraries.
  Open the Arduino Library Manager and install:
  - ArduinoJson
  - Adafruit NeoPixel

  The project folder already includes copies of these 
  fine libraries:
  - https://github.com/appzer/pushsafer-arduino-library/
  - https://github.com/ncmreynolds/ld2410

  You must also create an account with https://www.pushsafer.com
  and fill in the PushsaferKey variable as well as your
  wifi credentials.

  And finally, you'll need the RadSense device from:
  https://maketronics.no/radsense-1/
*/
...
void setup() {
  ...
  setPixels(0,0,55); // Set pixelsto blue
